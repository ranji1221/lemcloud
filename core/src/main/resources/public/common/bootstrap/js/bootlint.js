...
function getWidthOrHeight( elem, name, extra ) {
	...
	if ( val <= 0 || val == null ) {
		...
		// Check for styles in case a browser which returns unreliable values
...
(function (exports) {
    ...
    if (IN_NODE_JS) {
        ...
        (function () {
             ...
             * @param {boolean} [alertOpts.problemFree=true] Show one alert() at the end of linting if the pages has no lint problems?
             * @returns {undefined} Nothing
             */
